...
class UserController extends Controller
{
     ...
     * Submit form, if returned positive redirect to index, otherwise show the changePassword page again
     */
    public function changePassword_action()
    {
        // 1) CSRF-Token validieren
        // ------------------------------------------------
        if (!Csrf::isTokenValid()) {
            // Token ungültig -> angemessen reagieren
            // Kann z.B. Logout sein, damit kein Schaden entsteht
            LoginModel::logout();
            Redirect::home();
            exit();
        }
        ...
        // 2) Wenn Token ok, Passwort ändern
